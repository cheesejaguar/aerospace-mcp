...
class TestWingAnalysis:
    ...
    def test_wing_analysis_mach_effects(self):
        ...
        for low, high in zip(results_low_mach, results_high_mach, strict=False):
...
class TestAirfoilAnalysis:
    ...
    def test_reynolds_effects(self):
        ...
        for low_re, high_re in zip(results_low_re, results_high_re, strict=False):
    ...
    def test_mach_effects_airfoil(self):
        ...
        for low_m, high_m in zip(results_low_mach, results_high_mach, strict=False):
