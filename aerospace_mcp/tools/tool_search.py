...
TOOL_REGISTRY: list[ToolMetadata] = [
    ...
    ToolMetadata(
        ...
        parameters={
            ...
            "dynamics_model": "Dynamics model type: constant_velocity, constant_acceleration, orbital",
        },
        keywords=[
            "kalman",
            "filter",
    ...
    ToolMetadata(
        name="lqr_controller_design",
        description="Design Linear Quadratic Regulator (LQR) optimal controller for state-space systems",
        category="gnc",
        parameters={
    ...
    ToolMetadata(
        name="true_airspeed_converter",
        description="Convert between IAS, CAS, EAS, TAS, and Mach number at different altitudes",
        category="performance",
        parameters={
            "speed_value": "Input speed value (knots or Mach)",
            "speed_type": "Input type: IAS, CAS, EAS, TAS, or MACH",
            "altitude_ft": "Pressure altitude in feet",
            "temperature_c": "Outside air temperature (optional, uses ISA if not provided)",
            "position_error_kts": "Position error correction in knots",
        },
        keywords=[
            "airspeed",
            "true",
    ...
    ToolMetadata(
        name="stall_speed_calculator",
        description="Calculate stall speeds for different aircraft configurations (clean, takeoff, landing)",
        category="performance",
        parameters={
